...
function registerUser(){
    ...
    for(var i=0;i<newDatabase.length;i++){
        if (email.value==newDatabase[i][2] ||password.value==newDatabase[i][3]){
            alert("Sorry! the email or password is already exist");
            return;
        }
    }
    ...
    alert("Congratulation! Account is created.");
}
